...
## 🎯 About Me  
🚀 Passionate **Front-End Developer** with **3+ years of experience**, creating elegant and user-friendly web interfaces using **HTML, CSS, JavaScript, Bootstrap, TailwindCSS**, and **React.js**.  
💻 Currently growing into a **Full-Stack Developer (MERN Stack)** — mastering **React.js, Node.js, Express.js, MongoDB**, and **RESTful APIs**.  
🌱 I enjoy building **scalable, responsive, and high-performance** web applications that make an impact.  

---

## 💡 What I’m Working On  
- ⚛️ Enhancing my **React.js** skills by building interactive UI components and reusable structures.  
- 🌐 Developing **MERN stack projects** to strengthen my backend and API integration knowledge.  
- 🧠 Continuously learning, experimenting, and contributing to open-source projects.  
...
![EJS](https://img.shields.io/badge/EJS-8A2BE2?style=flat)
